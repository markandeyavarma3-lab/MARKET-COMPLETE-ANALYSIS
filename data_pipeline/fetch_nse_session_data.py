...
Run:
  py D:\MICC\data_pipeline\fetch_nse_session_data.py --poi
  py D:\MICC\data_pipeline\fetch_nse_session_data.py --sh
  py D:\MICC\data_pipeline\fetch_nse_session_data.py  (both)
