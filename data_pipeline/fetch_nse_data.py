...
Place at: D:\MICC\data_pipeline\fetch_nse_data.py
Run:
  py D:\MICC\data_pipeline\fetch_nse_data.py --fii     # FII/DII activity
  py D:\MICC\data_pipeline\fetch_nse_data.py --oi      # top OI contracts
  py D:\MICC\data_pipeline\fetch_nse_data.py --chain   # option chains
  py D:\MICC\data_pipeline\fetch_nse_data.py           # all
"""
...
def fetch_fii_dii(nse):
    info("Fetching FII/DII activity via nsefin...")
    c = get_conn()
