...
Run:
  py D:\MICC\data_pipeline\fetch_phase1_data.py          # all 5 sources
  py D:\MICC\data_pipeline\fetch_phase1_data.py --rbi    # only RBI
  py D:\MICC\data_pipeline\fetch_phase1_data.py --gsec   # only G-Sec yield
  py D:\MICC\data_pipeline\fetch_phase1_data.py --poi    # only participant OI
  py D:\MICC\data_pipeline\fetch_phase1_data.py --bse    # only shareholding
  py D:\MICC\data_pipeline\fetch_phase1_data.py --mospi  # only CPI/IIP
...
FRED_KEY  = "97dcf9c665ec4d3d4aeab55cbc113361"   # your existing key
