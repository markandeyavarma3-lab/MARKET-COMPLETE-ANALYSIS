...
fix_options_page.py
====================
Cleanly rewrites app/options/page.tsx.

The previous patch prepended the EpsilonTab block BEFORE the existing
file content, pushing "use client" to line 252.
Next.js requires "use client" to be the FIRST expression in the file.

This script writes the complete file from scratch with correct ordering:
  1. "use client"        <- must be first
  2. All imports
  3. EpsilonTab function
  4. OptionsPage default export

Usage: cd D:\\MICC && py fix_options_page.py
"""
...
OPTIONS_PAGE.parent.mkdir(parents=True, exist_ok=True)

OPTIONS_PAGE.write_text(r"""
"use client";
...
print(f"[OK] Rewrote: {OPTIONS_PAGE.relative_to(BASE)}")
print()
print("The error was: EpsilonTab block + imports were prepended BEFORE the existing")
print("file content, pushing 'use client' to line 252.")
print("Next.js requires 'use client' to be the VERY FIRST expression in the file.")
print()
print("Fixed: complete clean rewrite with correct order:")
print("  1. 'use client'")
print("  2. All imports")
print("  3. EpsilonTab function")
print("  4. OptionsPage default export")
print()
print("Next.js will hot-reload automatically.")
