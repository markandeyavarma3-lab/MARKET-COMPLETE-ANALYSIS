...
FIX_PIPELINE_NOW.py
====================
Drop this anywhere and run it. It reads your broken run_pipeline.py,
identifies the broken if-block, and writes a clean working version.

Run from D:\MICC:
  py D:\MICC\FIX_PIPELINE_NOW.py
"""

from pathlib import Path

TARGET = Path(r"D:\MICC\data_pipeline\run_pipeline.py")
...
print(f"Writing clean run_pipeline.py to: {TARGET}")

# Backup the broken file first
backup = TARGET.with_suffix(".py.broken_backup")
if TARGET.exists():
...
print(f"Done. Clean run_pipeline.py written.")
print()
print("Now test it:")
print(f"  py {TARGET} --check")
